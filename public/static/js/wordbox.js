    ...
    WordBox.prototype = {
        ...
        _create: function() {    
            ...
            if (this.options.isLead && this.options.leadWord) {
                this.words = [this.options.leadWord].concat(this._isRandArray(this.options.words, this.options.isRand));
            } else {
                this.words = this._isRandArray(this.options.words, this.options.isRand);
            }
        ...
        /*
         * 随机排序数组
         * @param array数组  isRand是否需要随机排序
         */
        _isRandArray: function(array, isRand) {
            if (isRand) {
              var data = this._randArray(array)
            }else{
              var data = array;
            }
