                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-3" style="float: left;">
                                        <select name="type" data-am-selected="{searchBox: 1}" id="parentSelect">
                                            ...
                                            <option value="<?php echo $category['id']; ?>" <?php if($article_info == true && $category['id'] == $article_info['type']): ?>selected="selected"<?php endif; ?>><?php echo $category['category_name']; ?></option>
                                            <?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                                    </div>
                                    
                                    <div class="am-u-sm-3" style="float: left;<?php if($child_category_list): ?>display: block;<?php else: ?>display: none;<?php endif; ?>" id="childSelect">
                                        <select name="category_id" data-am-selected="{searchBox: 1}">
                                            <?php if(is_array($child_category_list) || $child_category_list instanceof \think\Collection || $child_category_list instanceof \think\Paginator): $i = 0; $__LIST__ = $child_category_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$child): $mod = ($i % 2 );++$i;?>
                                            <option value="<?php echo $child['id']; ?>" <?php if($article_info == true && $child['id'] == $article_info['category_id']): ?>selected="selected"<?php endif; ?>><?php echo $child['category_name']; ?></option>
                                            <?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                                    </div>                                    
                                </div>
