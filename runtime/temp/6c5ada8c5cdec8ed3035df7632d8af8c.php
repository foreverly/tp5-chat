                ...
                <div class="tpl-block">
                        ...
                        <div class="am-u-sm-12 am-u-md-6">
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    <a href="/banner/edit" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span> 新增</a>
                    ...
                    <div class="am-g">
                        ...
                        <div class="tpl-table-images">
                            <?php if(is_array($banner_list) || $banner_list instanceof \think\Collection || $banner_list instanceof \think\Paginator): $i = 0; $__LIST__ = $banner_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$banner): $mod = ($i % 2 );++$i;?>
                            <div class="am-u-sm-12 am-u-md-6 am-u-lg-4">
                                <div class="tpl-table-images-content">
                                    <div class="tpl-table-images-content-i-time">发布时间：<?php echo $banner['created_time']; ?></div>
                                    <div class="tpl-i-title">
                                        <b><?php echo $banner['title']; ?></b>
                                    </div>
                                    <a href="javascript:;" class="tpl-table-images-content-i" style="height: 12vw;">
                                        <!-- <span class="tpl-table-images-content-i-shadow"></span> -->
                                        <img src="<?php echo $banner['img_url']; ?>" alt="">
                                    </a>
                                    <div class="tpl-table-images-content-block">
                                        ...
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-sm tpl-edit-content-btn">
                                                <!-- <button type="button" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span> 新增</button> -->
                                                <a href="/banner/edit?id=<?php echo $banner['id']; ?>" class="am-btn am-btn-default am-btn-secondary" role="button"><span class="am-icon-edit"></span> 编辑</a>
                                                <!-- <button type="button" class="am-btn am-btn-default am-btn-warning"><span class="am-icon-archive"></span> 审核</button> -->
                                                <a href="/banner/del?id=<?php echo $banner['id']; ?>" class="am-btn am-btn-default am-btn-danger" role="button"><span class="am-icon-trash-o"></span> 删除</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="am-hide-sm-only"><?php echo $banner['img_url']; ?></td>
                                            <td class="am-hide-sm-only"><?php echo $banner['status']; ?></td>
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">

                                                        <a class="am-btn am-btn-default am-btn-xs am-text-secondary a-btn" onclick="doEdit(<?php echo $banner['id']; ?>)">
                                                            
                                                            <span class="am-icon-pencil-square-o"></span> 编辑
                                                        </a>

                                                        <a class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only a-btn" onclick="doDel(<?php echo $banner['id']; ?>)">
...
function doEdit(id){
    window.location.href = API_URL+'/banner/edit?id='+id;
}

function doDel(id){
    window.location.href = API_URL+'/banner/del?id='+id;
}
