            ...
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> <?php if($menu_info): ?>编辑<?php else: ?>新增<?php endif; ?>菜单
                    </div>
                </div>
...
$(".am-btn-primary").on('click', function(){
    ...
    $.ajax({
        ...
        success:function(res) {
            if (res.code == 200) {
                window.location.href = API_URL+'/menu?type='+<?php echo $type; ?>;
            }else{  
                alert(res.msg)
            }
        }
