<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"/mnt/d/Workspace/www/tp5-chat/public/../application/index/view/login/lw-log.html";i:1558406246;}*/ ?>
...
<header>
  ...
  <div class="log-re">
    <button type="button" class="am-btn am-btn-default am-radius log-button" id="btnReg">注册</button>
  </div> 
</header>
...
<div class="log"> 
  ...
  <div class="am-u-lg-3 am-u-md-6 am-u-sm-8 am-u-sm-centered log-content">
    <h1 class="log-title am-animation-slide-top">吾爱学</h1>
    <br>
    <form class="am-form" id="log-form">
      ...
      <div class="am-input-group am-animation-slide-left log-animation-delay">       
        <input type="text" class="am-form-field am-radius log-input" name="Password" placeholder="密码" minlength="6" required>
        <span class="am-input-group-label log-icon am-radius"><i class="am-icon-lock am-icon-sm am-icon-fw"></i></span>
      </div>      
      <br>

      <button type="button" id="btnLog" class="am-btn am-btn-primary am-btn-block am-btn-lg am-radius am-animation-slide-bottom log-animation-delay">登 录</button>
...
<script src="/static/blog/assets/js/app.js"></script>
...
<script type="text/javascript">
  ...
  $("#btnLog").on('click', function(){
    var formData = $("#log-form").serialize();
