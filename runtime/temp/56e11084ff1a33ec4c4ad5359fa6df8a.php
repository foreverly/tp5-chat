                    ...
                    <div class="am-g tpl-amazeui-form">
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal" id="catForm" enctype='multipart/form-data'>
                                ...
                                <input type="hidden" id="id" name="id" value="<?php if($category_info == true): ?><?php echo $category_info['id']; endif; ?>">

                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">分类名称</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" id="category_name" name="category_name" placeholder="分类名称" value="<?php if($category_info == true): ?><?php echo $category_info['category_name']; endif; ?>">
                                        <small>输入分类名称。</small>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9" id="parentMenu">
                                        ...
                                        <select name="pid" data-am-selected="{btnSize: 'sm'}">
                                            ...
                                            <option value="<?php echo $category['id']; ?>" <?php if($category_info == true && $category['id'] == $category_info['pid']): ?>selected="selected"<?php endif; ?>><?php echo $category['category_name']; ?></option>
                                            <?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                                ...
                                <!-- <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">父分类</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" id="pid" name="pid" placeholder="副标题" value="<?php if($category_info == true): ?><?php echo $category_info['pid']; endif; ?>">
                                        <small>输入父分类。</small>
                                    </div>
                                </div> -->   
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="number" id="status" name="status" value="<?php if($category_info == true): ?><?php echo $category_info['status']; else: ?>1<?php endif; ?>">
                                        <small>不填为默认开启</small>
                                    </div>
                                </div>                        
