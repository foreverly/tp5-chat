                    ...
                    <div class="am-g tpl-amazeui-form">
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal" id="bannerForm" enctype='multipart/form-data'>
                                ...
                                <input type="hidden" id="id" name="id" value="<?php if($banner_info == true): ?><?php echo $banner_info['id']; endif; ?>">

                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">标题</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" id="title" name="title" placeholder="菜单名称" value="<?php if($banner_info == true): ?><?php echo $banner_info['title']; endif; ?>">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" id="sub_title" name="sub_title" placeholder="副标题" value="<?php if($banner_info == true): ?><?php echo $banner_info['sub_title']; endif; ?>">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" id="desc" name="desc" placeholder="描述" value="<?php if($banner_info == true): ?><?php echo $banner_info['desc']; endif; ?>">
                                    ...
                                    <div class="am-u-sm-9">
                                        ...
                                        <div class="am-form-group am-form-file">
                                            ...
                                            <div class="tpl-form-file-img" id="doPreview" if $banner_info neq true}style="display: none;"{/if}>
                                                <img src="<?php if($banner_info == true): ?><?php echo $banner_info['img_url']; else: ?>/static/blog/admin1/img/a5.png<?php endif; ?>" alt="">
                                            </div>

                                            <button type="button" id="uploadBtn" class="am-btn <?php if($banner_info): ?>am-btn-primary<?php else: ?>am-btn-default<?php endif; ?> am-btn-sm">
                                                <i class="am-icon-cloud-upload"></i> <?php if($banner_info): ?>重新选择图片<?php else: ?>选择要上传的图片<?php endif; ?>
                                            </button>
                                            <input type="file" name="images" multiple="multipart/form-data" onchange="showPreview(this)">
                                            <input type="hidden" id="img_url" name="img_url" value="<?php if($banner_info == true): ?><?php echo $banner_info['img_url']; endif; ?>">
                                        </div>
                                    </div>
                                </div>   
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" id="url" name="url" value="<?php if($banner_info == true): ?><?php echo $banner_info['url']; endif; ?>">
                                        <small>输入跳转地址</small>
                                    </div>
                                </div>   
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="number" id="order" name="order" value="<?php if($banner_info == true): ?><?php echo $banner_info['order']; endif; ?>">
                                        <small>不填为默认排序</small>
                                    </div>
                                </div>      
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="number" id="status" name="status" value="<?php if($banner_info == true): ?><?php echo $banner_info['status']; endif; ?>">
                                        <small>不填为默认开启</small>
                                    </div>
                                </div>                        
