                ...
                <div class="tpl-block">
                    <div class="am-g">
                        <div class="am-u-sm-12 am-u-md-6">
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    <a href="/menu/edit?type=<?php echo $type; ?>" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span> 新增</a>
                        ...
                        <div class="am-u-sm-12 am-u-md-3" style="float: left;">
                            <div class="am-form-group" id="menuType">
                                <select data-am-selected="{btnSize: 'sm'}">
                                    <option value="0" <?php if($type == 0): ?>selected="selected"<?php endif; ?>><a href="/menu">后台菜单</a></option>
                                    <option value="1" <?php if($type == 1): ?>selected="selected"<?php endif; ?>><a href="/menu">前台菜单</a></option>
                                </select>
                            </div>
                        </div>
                        
                        <div class="am-u-sm-12 am-u-md-3" style="float: left;">
                            <div class="am-form-group" id="parentMenu">
                                <select data-am-selected="{btnSize: 'sm'}">
                                    <option value="0"><a href="/menu">所有菜单</a></option>
                                    ...
                                    <option value="<?php echo $menu['id']; ?>" <?php if($parent == $menu['id']): ?>selected="selected"<?php endif; ?>><?php echo $menu['name']; ?></option>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                        </div>
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-author am-hide-sm-only">图标</th>
                                            <th class="table-date am-hide-sm-only">路由</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="#"><?php echo $menu['name']; ?></a></td>
                                            <td><?php echo $menu['parent']; ?></td>
                                            <td class="am-hide-sm-only"><i class="am-icon-<?php echo $menu['data']; ?>"></i></td>
                                            <td class="am-hide-sm-only"><?php echo $menu['route']; ?></td>
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">

                                                        <a class="am-btn am-btn-default am-btn-xs am-text-secondary a-btn" onclick="doEdit(<?php echo $menu['id']; ?>)">
                                                            <!-- <a href="/menu/edit?id=<?php echo $menu['id']; ?>"> -->
                                                            <span class="am-icon-pencil-square-o"></span> 编辑
                                                            <!-- </a> -->
                                                        </a>

                                                        <!-- <a class="am-btn am-btn-default am-btn-xs am-hide-sm-only a-btn" onclick="doCopy(<?php echo $menu['id']; ?>)">
                                                            <span class="am-icon-copy"></span> 复制
                                                        </a> -->

                                                        <a class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only a-btn" onclick="doDel(<?php echo $menu['id']; ?>)">
...
$("#menuType select").on('change', function(){
    var type = $(this).val();
    var parent = $("#parentMenu select").val();
    window.location.href = API_URL+'/menu?type='+type+'&parent='+parent;
})
    
$("#parentMenu select").on('change', function(){
    var type = $("#menuType select").val();
    var parent = $(this).val();
    window.location.href = API_URL+'/menu?type='+type+'&parent='+parent;
})
...
function doEdit(id){
    var type = $("#menuType select").val();
    window.location.href = API_URL+'/menu/edit?type='+type+'&id='+id;
}

function doDel(id){
    window.location.href = API_URL+'/menu/del?id='+id;
}
