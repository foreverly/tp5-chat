                        ...
                        <div class="am-u-sm-12 am-u-md-6">
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    <a href="/menu/edit" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span> 新增</a>
...
$("#parentMenu select").on('change', function(){
    var parent = $(this).val();
    window.location.href = API_URL+'/menu?parent='+parent;
})

function doEdit(id){
    window.location.href = API_URL+'/menu/edit?id='+id;
}
